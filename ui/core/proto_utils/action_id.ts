...
export const resourceTypeToIcon: Record<ResourceType, string> = {
	...
	[ResourceType.ResourceTypeBloodRune]: '/wowsim-wotlk/assets/img/blood_rune.png',
	[ResourceType.ResourceTypeFrostRune]: '/wowsim-wotlk/assets/img/frost_rune.png',
	[ResourceType.ResourceTypeUnholyRune]: '/wowsim-wotlk/assets/img/unholy_rune.png',
	[ResourceType.ResourceTypeDeathRune]: '/wowsim-wotlk/assets/img/death_rune.png',
};
